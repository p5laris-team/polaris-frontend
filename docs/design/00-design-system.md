...
> 이 문서는 초기 디자인 시스템 원문입니다. 프로젝트 실행과 문서 지도는 [루트 README](../../README.md)를 기준으로 확인하세요.
...
| 경로 | 내용 |
|---|---|
| [`00-design-system.md`](./00-design-system.md) | 이 문서 — 브랜드 컨셉, 콘텐츠·시각 원칙, 아이콘 가이드 |
...
React Native에서는 토큰을 JS 객체로 변환한 `tokens.js`를 import — [`ui_kits/mobile/README.md`](../../ui_kits/mobile/README.md) 참고.
